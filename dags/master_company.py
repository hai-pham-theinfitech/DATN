...
with DAG(
    dag_id="master_company_company",
    start_date=pendulum.datetime(2023, 1, 1, tz="Asia/Ho_Chi_Minh"),
    schedule=None,
    catchup=False,
    tags=["scrapy", "minio", "master_company", "parquet"],
) as dag:
    run_scrapy_task = BashOperator(
        task_id="crawl",
        bash_command=bash(media="master_company", type="company"),
    ...
    #     op_kwargs={"media": "master_company"},
