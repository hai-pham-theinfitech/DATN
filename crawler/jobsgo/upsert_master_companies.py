...
def upsert_companies_from_jobsgo(
    master_company_table: str = "s3a://datn/master/company",
    company_table: str = "s3a://datn/raw/jobsgo/company",
    uuid_table: str = "s3a://datn/uuid/jobsgo",
):
    ...
    upsert_companies_table(
        ...
        company_with_uuid, 
        [
            ColumnInfo("company_id", "jobsgo_company_id", quality),
