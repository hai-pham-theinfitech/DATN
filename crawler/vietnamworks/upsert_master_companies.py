...
def upsert_companies_from_vietnamworks(
    master_company_table: str = "s3a://datn/master/company",
    company_table: str = "s3a://datn/raw/vietnamworks/company",
    uuid_table: str = "s3a://datn/uuid/vietnamworks",
):
    ...
    upsert_companies_table(
        ...
        company_with_uuid, 
        [
            ColumnInfo("company_id", "vietnamworks_company_id", quality),
            ...
            ColumnInfo("company_profile", "description", quality),
...
upsert_companies_from_vietnamworks()