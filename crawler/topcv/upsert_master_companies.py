...
def upsert_companies_from_topcv(
    master_company_table: str = "s3a://datn/master/company",
    company_table: str = "s3a://datn/raw/topcv/company",
    uuid_table: str = "s3a://datn/uuid/topcv",
):
    ...
    upsert_companies_table(
        ...
        company_with_uuid, 
        [
            ColumnInfo("company_id", "topcv_company_id", quality),
