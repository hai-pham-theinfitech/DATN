...
def upsert_companies_from_vieclam24h(
    master_company_table: str = "s3a://datn/master/company",
    company_table: str = "s3a://datn/raw/vieclam24h/company",
    ...
    upsert_companies_table(
        ...
        company_with_uuid, 
        [
            ColumnInfo("company_id", "vieclam24h_company_id", quality),
...
upsert_companies_from_vieclam24h()